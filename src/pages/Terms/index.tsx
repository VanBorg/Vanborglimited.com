        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <motion.div
              ...
              className="mb-4"
            >
              <Badge variant="primary" size="lg">TERMS OF SERVICE</Badge>
            </motion.div>
          ...
          >
            <GlassCard className="p-8 mb-8" intensity="medium">
              <div className="prose prose-lg max-w-none text-light-text-secondary dark:text-dark-text-secondary">
                ...
                <hr />
                <p>
                  These Terms of Service ("Terms") govern your access to and use of Van Borg's website, products, and services, including our AI chatbot and automation systems ("Services"). Please read these Terms carefully before using our Services.
                </p>
                <p>
