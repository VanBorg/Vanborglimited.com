          ...
          <table className="w-full">
            ...
            <tbody>
              {automations.map((automation, index) => {
                const IconComponent = (Icons as any)[automation.icon] || Icons.Zap;
                ...
                return (
                  <React.Fragment key={index}>
                    <tr className={cn(
                      "transition-colors duration-300 border-b border-light-text-secondary/10 dark:border-dark-text-secondary/10 hover:bg-light-bg-secondary/60 dark:hover:bg-dark-bg-secondary/60",
                      isEven ? "bg-light-bg-primary/60 dark:bg-dark-bg-primary/60" : "bg-transparent",
                      isExpanded && "border-b-0"
                    )}>
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-3">
                          <div className="p-2 rounded-full bg-gradient-to-br from-light-brand-primary/20 to-light-brand-secondary/20 dark:from-dark-brand-primary/20 dark:to-dark-brand-secondary/20 border border-light-brand-primary/30 dark:border-dark-brand-primary/30">
                      ...
                      <td className="px-3 py-2 text-center">
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-light-brand-primary/10 dark:bg-dark-brand-primary/10 text-light-brand-primary dark:text-dark-brand-primary border border-light-brand-primary/30 dark:border-dark-brand-primary/30">
                          <Clock className="mr-1" size={12} />
                          {automation.timeline}
                        </span>
                      </td>
                      <td className="px-3 py-2 text-center">
                        <span className="inline-flex px-2.5 py-1 rounded-full text-xs font-medium bg-light-brand-primary/10 dark:bg-dark-brand-primary/10 text-light-brand-primary dark:text-dark-brand-primary border border-light-brand-primary/30 dark:border-dark-brand-primary/30">
                          {automation.price}
                        </span>
                      </td>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {automation.recommendedIn.map((id, idx) => {
                            ...
                            return (
                              <span
                                key={idx}
                                className="rounded-full px-2 py-0.5 text-xs bg-light-brand-secondary/10 dark:bg-dark-brand-secondary/10 text-light-brand-primary dark:text-dark-brand-primary border border-light-brand-primary/30 dark:border-dark-brand-primary/30"
                              >
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className="inline-flex items-center justify-center px-3 py-1.5 rounded-md bg-light-brand-primary/10 hover:bg-light-brand-primary/20 dark:bg-dark-brand-primary/10 dark:hover:bg-dark-brand-primary/20 text-light-brand-primary dark:text-dark-brand-primary transition-colors duration-200"
                        >
                          <span>Details</span>
                    ...
                    {isExpanded && (
                      <tr className={cn(
                        ...
                        <td colSpan={6} className="px-6 py-4">
                          <div className="bg-light-bg-secondary/50 dark:bg-dark-bg-secondary/50 p-4 rounded-lg">
